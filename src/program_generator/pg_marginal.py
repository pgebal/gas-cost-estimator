...
def _generate_calldata_program(operation, op_count, max_op_count):
  """
  Generates a program for CALLDATASIZE, CALLDATACOPY, CALLDATALOAD
  """
  ...
  if operation['Mnemonic'] == 'CALLDATALOAD':
    ...
    op_deployment_code = '6961' + op_subcontext_code + '5f526002601ef36000526016600a6000f0'
    no_op_deployment_code = '6860' + no_op_subcontext_code + '5f526001601ff3600052601760096000f0'
  ...
  # 32 bytes calldata
  no_op_calls = '600060006020600060008561fffff150' * (max_op_count - op_count)
  op_calls = '600060006020600060008561fffff150' * op_count
